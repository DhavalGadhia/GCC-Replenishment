...
RUN_BASICS = "Basics Repeat Replenishment"
...
def inject_theme():
    ...
    .st-key-run_fashion, .st-key-run_conn{ margin-top:-30px !important; }
...
with st.container(border=True):
    ...
    # Pack rounding thresholds and the default target grid are replenishment
    # controls. A connection ships only what the DEPTH file asks for, in whole
    # packs, so neither applies.
    if run_type == RUN_REPLENISHMENT:
        # ---- rounding + targets ------------------------------------------------
